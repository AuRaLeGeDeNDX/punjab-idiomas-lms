...
<div class="creative-page-header fade-in-up">
    <h1><i class="fas fa-list-alt me-2"></i>System Activity Logs</h1>
    <p>Monitor all user and system activities across the platform.</p>
</div>
...
<div class="creative-card mb-4 fade-in-up stagger-1">
    <div class="creative-card-header">
        ...
        <a href="{{ route('admin.logs.index') }}" class="btn btn-sm btn-outline-secondary">Clear Filters</a>
    </div>
                        ...
                        <td>
                            @if(count($log->properties) > 0)
                                <button type="button" class="btn btn-sm btn-outline-secondary" disabled>
                                    <i class="fas fa-code me-1"></i> Data ({{ count($log->properties) }})
                                </button>
                            @else
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <p class="text-muted mb-0">No logs match the current filters.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse

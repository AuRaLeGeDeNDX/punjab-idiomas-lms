    ...
    <div class="bg-orange-900 dark:bg-orange-950 text-white py-2 px-4 hidden md:flex justify-between items-center text-sm transition-colors duration-300">
        <div class="max-w-7xl mx-auto w-full flex justify-between items-center">
            <div class="flex space-x-6">
                ...
                <a href="https://maps.app.goo.gl/6bVUrJMgQhk3yK5i8" target="_blank" class="flex items-center hover:text-yellow-400 transition-colors"><i data-lucide="map-pin" class="w-4 h-4 mr-2 text-yellow-400"></i> Calle Padilla 391, Barcelona</a>
            </div>
            ...
            <div class="px-4 pt-2 pb-6 space-y-1">
                ...
                <div class="px-3 py-2">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <a href="#" onclick="setLanguage('pa', event)" class="text-center px-2 py-1.5 border border-slate-200 dark:border-slate-600 rounded-md text-sm {{ app()->getLocale() == 'pa' ? 'bg-orange-50 dark:bg-slate-700 text-orange-700 dark:text-yellow-400 font-bold border-orange-300 dark:border-yellow-500' : 'text-slate-600 dark:text-slate-300' }}">ਪੰਜਾਬੀ</a>
                        <a href="#" onclick="setLanguage('ur', event)" class="text-center px-2 py-1.5 border border-slate-200 dark:border-slate-600 rounded-md text-sm {{ app()->getLocale() == 'ur' ? 'bg-orange-50 dark:bg-slate-700 text-orange-700 dark:text-yellow-400 font-bold border-orange-300 dark:border-yellow-500' : 'text-slate-600 dark:text-slate-300' }}">اردو</a>
                    </div>
                </div>

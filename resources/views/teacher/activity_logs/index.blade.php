...
@section('title', 'Student Activity Logs')
...
<div class="creative-page-header fade-in-up">
    <h1><i class="fas fa-users-cog me-2"></i>Student Activity Logs</h1>
    <p>Monitor your students' interactions with your courses and modules.</p>
</div>
...
<div class="creative-card mb-4 fade-in-up stagger-1">
    <div class="creative-card-header">
        ...
        <a href="{{ route('teacher.logs.index') }}" class="btn btn-sm btn-outline-secondary">Clear Filters</a>
    </div>
    <div class="creative-card-body">
        <form action="{{ route('teacher.logs.index') }}" method="GET" class="row g-3">
            <div class="col-md-4">
                <label for="student_id" class="creative-form-label">Student</label>
                <select name="student_id" id="student_id" class="creative-form-select" onchange="this.form.submit()">
                        ...
                        <td>
                            @if($log->causer)
                                <div class="d-flex align-items-center">
                                    <div class="creative-avatar me-2" style="width: 32px; height: 32px;">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <p class="text-muted mb-0">No logs match the current filters or your students haven't generated any activity yet.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse

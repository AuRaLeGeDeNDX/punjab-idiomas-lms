...
<div class="container-fluid">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0">
                    ...
                    <li class="breadcrumb-item active" style="color: #764ba2;">Edit</li>
                </ol>
            </nav>
            <style>
            ...
            <h1><i class="fas fa-edit me-2"></i>Edit Assignment</h1>
    ...
    <form method="POST" action="{{ route($routePrefix . '.courses.modules.subpages.assignments.update', [$course, $module, $subpage, $assignment]) }}">
        @csrf
        @method('PUT')
                    ...
                    <div class="creative-card-body">
                        ...
                        <div class="creative-form-group">
                            ...
                            <textarea class="creative-form-input @error('instructions') is-invalid @enderror" 
                                      id="instructions" 
                                      name="instructions" 
                                      rows="5">{{ old('instructions', $assignment->instructions) }}</textarea>
                            @error('instructions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="creative-card-body">
                        ...
                        <div class="creative-form-group">
                            ...
                            <select class="creative-form-input @error('assignment_type') is-invalid @enderror" 
                                ...
                                <option value="exam" {{ old('assignment_type', $assignment->assignment_type) == 'exam' ? 'selected' : '' }}>Exam</option>
                        ...
                        <div class="creative-form-group">
                            ...
                            <select class="creative-form-input @error('submission_type') is-invalid @enderror" 
                                ...
                                <option value="both" {{ old('submission_type', $assignment->submission_type) == 'both' ? 'selected' : '' }}>Text & File</option>
                            </select>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" 
                                   ...
                                   name="auto_grade" 
                                   value="1" 
                                   {{ old('auto_grade', $assignment->auto_grade) ? 'checked' : '' }}>
                    ...
                    <div class="creative-card-body">
                        @if($assignment->is_published)
                            <div class="alert alert-success mb-3">
                                ...
                                <br>
                                <small>Published on {{ $assignment->published_at->format('M j, Y g:i A') }}</small>
                            </div>
                        @else
                            <!-- Publish Now -->
                            <div class="mb-3 form-check">
                            ...
                            <div class="creative-form-group">
                                ...
                                <input type="datetime-local" 
                                       ...
                                       value="{{ old('scheduled_publish_at', $assignment->scheduled_publish_at ? $assignment->scheduled_publish_at->format('Y-m-d\TH:i') : '') }}">
                            ...
                            @if($assignment->isScheduled())
                                <div class="alert alert-info mb-3">
                                    ...
                                    <br>
                                    <small>Will publish on {{ $assignment->scheduled_publish_at->format('M j, Y g:i A') }}</small>
                                </div>
                            @endif
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (publishCheckbox && scheduleInput) {

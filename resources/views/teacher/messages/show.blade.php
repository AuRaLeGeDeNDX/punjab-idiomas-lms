...
@section('title', 'Ver Mensaje - Profesor')
    ...
    <div class="row">
        <div class="col-12 col-xl-10 mx-auto">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>
                    <a href="{{ route('teacher.contact-messages.index') }}" class="text-decoration-none text-muted me-2">
                ...
                <div class="col-md-5">
                    <div class="creative-card h-100">
                        <div class="creative-card-body d-flex flex-column">
                            ...
                            @else
                                <form action="{{ route('teacher.contact-messages.reply', $message) }}" method="POST" class="d-flex flex-column flex-grow-1">
                                    @csrf

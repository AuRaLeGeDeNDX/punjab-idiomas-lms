...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Rubric</h1>
        ...
        <!-- Rubric Form -->
        <form action="{{ route('teacher.rubrics.update', [$assignment, $rubric]) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          ...
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Optional description of the rubric">{{ old('description', $rubric->description) }}</textarea>
            </div>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('criteria.' . $index . '.name', $criterion->criterion_name) }}"
                                       required
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="criteria[{{ $index }}][description]" 
                                          rows="2"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('criteria.' . $index . '.description', $criterion->criterion_description) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('criteria.' . $index . '.max_points', $criterion->max_points) }}"
                                       required
                                       min="0"
                                       step="0.01"
...
@push('scripts')
<script>
let criterionCount = {{ $rubric->criteria->count() }};
